                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "float", "bang" ],
                                    "patching_rect": [ 32.0, 112.0, 194.0, 22.0 ],
                                    "text": "buffer~ pstretch_buf_5 @file jongly"
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 3,
                                    "outlettype": [ "signal", "signal", "bang" ],
                                    "patching_rect": [ 32.0, 313.0, 205.0, 22.0 ],
                                    "text": "paulstretch~ pstretch_buf_5 @loop 1"
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "int" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 32.0, 264.0, 24.0, 24.0 ]
                                }
                            }
                        ],
                        "lines": [
